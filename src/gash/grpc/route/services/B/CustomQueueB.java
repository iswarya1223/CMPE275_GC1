...
public class CustomQueueB extends RouteServerImpl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            CustomQueueB customQueue = new CustomQueueB();
...
//            System.out.println("failure thread");
    ...
    protected ByteString process(Route msg) {
        ...
        byte[] raw = "Custom Queue B forwarded message".getBytes();
    ...
    public void start() throws Exception {
        this.svr = ServerBuilder.forPort(RouteServer.getInstance().getServerPort()).addService(new CustomQueueB()).build();
        ...
        getRuntime().addShutdownHook(new Thread(CustomQueueB.this::stop));
    }
}
