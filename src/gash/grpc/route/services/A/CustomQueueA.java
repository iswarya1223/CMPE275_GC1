...
public class CustomQueueA extends RouteServerImpl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            CustomQueueA customQueue = new CustomQueueA();
    ...
    public void start() throws Exception {
        this.svr = ServerBuilder.forPort(RouteServer.getInstance().getServerPort()).addService(new CustomQueueA()).build();
        ...
        getRuntime().addShutdownHook(new Thread(CustomQueueA.this::stop));
    }
}
