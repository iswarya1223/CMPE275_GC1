...
public class CustomQueueC extends RouteServerImpl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            CustomQueueC customQueue = new CustomQueueC();
...
//            System.out.println("failure thread");
    ...
    protected ByteString process(Route msg) {
        ...
        byte[] raw = "Custom Queue C forwarded message".getBytes();
    ...
    public void start() throws Exception {
        this.svr = ServerBuilder.forPort(RouteServer.getInstance().getServerPort()).addService(new CustomQueueC()).build();
        ...
        getRuntime().addShutdownHook(new Thread(CustomQueueC.this::stop));
    }
}
